...
SOURCEFILES_QUOTED_IF_SPACED=main.c src/Comms.c src/chip_setup.c src/isr.c src/buffers.c src/globals.c src/gps.c src/temp_press.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.o ${OBJECTDIR}/src/Comms.o ${OBJECTDIR}/src/chip_setup.o ${OBJECTDIR}/src/isr.o ${OBJECTDIR}/src/buffers.o ${OBJECTDIR}/src/globals.o ${OBJECTDIR}/src/gps.o ${OBJECTDIR}/src/temp_press.o
POSSIBLE_DEPFILES=${OBJECTDIR}/main.o.d ${OBJECTDIR}/src/Comms.o.d ${OBJECTDIR}/src/chip_setup.o.d ${OBJECTDIR}/src/isr.o.d ${OBJECTDIR}/src/buffers.o.d ${OBJECTDIR}/src/globals.o.d ${OBJECTDIR}/src/gps.o.d ${OBJECTDIR}/src/temp_press.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.o ${OBJECTDIR}/src/Comms.o ${OBJECTDIR}/src/chip_setup.o ${OBJECTDIR}/src/isr.o ${OBJECTDIR}/src/buffers.o ${OBJECTDIR}/src/globals.o ${OBJECTDIR}/src/gps.o ${OBJECTDIR}/src/temp_press.o

# Source Files
SOURCEFILES=main.c src/Comms.c src/chip_setup.c src/isr.c src/buffers.c src/globals.c src/gps.c src/temp_press.c
...
${OBJECTDIR}/src/gps.o: src/gps.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/gps.c  -o ${OBJECTDIR}/src/gps.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/gps.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/src/gps.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
	
${OBJECTDIR}/src/temp_press.o: src/temp_press.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/src" 
	@${RM} ${OBJECTDIR}/src/temp_press.o.d 
	@${RM} ${OBJECTDIR}/src/temp_press.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/temp_press.c  -o ${OBJECTDIR}/src/temp_press.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/temp_press.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -mno-eds-warn  -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/src/temp_press.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/src/gps.o: src/gps.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/gps.o.d 
	@${RM} ${OBJECTDIR}/src/gps.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/gps.c  -o ${OBJECTDIR}/src/gps.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/gps.o.d"      -mno-eds-warn  -g -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/src/gps.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/src/temp_press.o: src/temp_press.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/temp_press.o.d 
	@${RM} ${OBJECTDIR}/src/temp_press.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  src/temp_press.c  -o ${OBJECTDIR}/src/temp_press.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/src/temp_press.o.d"      -mno-eds-warn  -g -omf=elf -O0 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/src/temp_press.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
