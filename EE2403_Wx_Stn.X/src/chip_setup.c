...
//        AD1CHS123 = 0b0000000000000000;
        ...
        OpenADC1(
        (ADC_MODULE_ON & ADC_IDLE_STOP & ADC_AD12B_10BIT & ADC_FORMAT_INTG & ADC_SSRC_MANUAL & ADC_AUTO_SAMPLING_OFF & ADC_MULTIPLE & ADC_SAMP_OFF),
        (ADC_VREF_EXT_EXT & ADC_SCAN_OFF & ADC_SELECT_CHAN_0 & ADC_BUF_FILL_0x0_0x7 & ADC_SETS_OF_SAMPLES_PER_INT_1 & ADC_ALT_BUF_OFF & ADC_ALT_INPUT_OFF ),
        (ADC_CONV_CLK_INTERNAL_RC & ADC_SAMPLE_TIME_31 & ADC_CONV_CLK_1Tcy),
        (ADC_DMA_DIS & ADC_DMA_BUF_LOC_1 & ADC_CH123_NEG_SAMPLEB_VREFN & ADC_CH123_NEG_SAMPLEA_VREFN & ADC_CH0_NEG_SAMPLEB_VREFN & ADC_CH0_POS_SAMPLEA_AN12 & ADC_RESULT_SECOND),
        (SCAN_ALL_16_31),
        (ENABLE_VREF_N_ANA & ENABLE_VREF_P_ANA),
                0,
        (ENABLE_AN12_ANA),
                0,
                0,
